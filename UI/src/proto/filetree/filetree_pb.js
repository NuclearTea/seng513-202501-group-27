...
goog.exportSymbol('proto.filetree.ReuploadRequest', null, global);
 ...
 * @constructor
 */
proto.filetree.ReuploadRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.filetree.ReuploadRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.filetree.ReuploadRequest.displayName = 'proto.filetree.ReuploadRequest';
}
 ...
 * @return {!Object}
 */
proto.filetree.ReuploadRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.filetree.ReuploadRequest.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.filetree.ReuploadRequest} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.filetree.ReuploadRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    projectslug: jspb.Message.getFieldWithDefault(msg, 1, ""),
    root: (f = msg.getRoot()) && proto.filetree.Directory.toObject(includeInstance, f),
    projecttype: jspb.Message.getFieldWithDefault(msg, 3, 0)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.filetree.ReuploadRequest}
 */
proto.filetree.ReuploadRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.filetree.ReuploadRequest;
  return proto.filetree.ReuploadRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.filetree.ReuploadRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.filetree.ReuploadRequest}
 */
proto.filetree.ReuploadRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.filetree.ReuploadRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.filetree.ReuploadRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.filetree.ReuploadRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.filetree.ReuploadRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getProjectslug();
  if (f.length > 0) {
    writer.writeString(
      1,
      f
...
/**
 * optional string projectSlug = 1;
 * @return {string}
 */
proto.filetree.ReuploadRequest.prototype.getProjectslug = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.filetree.ReuploadRequest} returns this
 */
proto.filetree.ReuploadRequest.prototype.setProjectslug = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};


/**
 * optional Directory root = 2;
 * @return {?proto.filetree.Directory}
 */
proto.filetree.ReuploadRequest.prototype.getRoot = function() {
  return /** @type{?proto.filetree.Directory} */ (
    jspb.Message.getWrapperField(this, proto.filetree.Directory, 2));
};
 ...
 * @return {!proto.filetree.ReuploadRequest} returns this
*/
proto.filetree.ReuploadRequest.prototype.setRoot = function(value) {
 ...
 * @return {!proto.filetree.ReuploadRequest} returns this
 */
proto.filetree.ReuploadRequest.prototype.clearRoot = function() {
  return this.setRoot(undefined);
};
 ...
 * @return {boolean}
 */
proto.filetree.ReuploadRequest.prototype.hasRoot = function() {
  return jspb.Message.getField(this, 2) != null;
};


/**
 * optional BackendType projectType = 3;
 * @return {!proto.filetree.BackendType}
 */
proto.filetree.ReuploadRequest.prototype.getProjecttype = function() {
  return /** @type {!proto.filetree.BackendType} */ (jspb.Message.getFieldWithDefault(this, 3, 0));
};
 ...
 * @return {!proto.filetree.ReuploadRequest} returns this
 */
proto.filetree.ReuploadRequest.prototype.setProjecttype = function(value) {
